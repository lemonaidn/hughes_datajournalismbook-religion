...
**Task** Run the following code to clean the numeric columns and find the top 10 states by number of congregations. In the space below, explain what each step of the code is doing in English. **Answer**
...
**Task** Run the following code to load the CARA data. Explain what you see after running the code in the space below. **Answer**
...
**Task** Run the following code. Explain what you see after running the code in the space below. Describe any pattern you notice. **Answer**
