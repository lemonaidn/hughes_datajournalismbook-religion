...
**Task** Run the following code. Describe the output in the space below. How many churches are in Prince George's County? **Answer**
...
**Task** Run the following code. Describe the output in the space below. What spatial patterns do you notice? Which zip codes have the most churches? **Answer**
